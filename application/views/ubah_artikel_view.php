                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="judul" class="form-control" id="judul" name="judul" value="<?= $artikel['judul']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control rounded-0" id="isi" name="isi" rows="6"><?= $artikel['isi']; ?></textarea>
